...
void przod()
{
	if(driving_mode[0]==0){	i=0;				//ustawianie kierunku jazdy
		driving_mode[0]++;driving_mode[1]=0;driving_mode[2]=0;driving_mode[3]=0;
		...
		set_value_obrot_min=500;				//wartoœc zadana = 500obr/min - prêdkosc znamionowa
